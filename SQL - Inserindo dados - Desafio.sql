...
values ('Maria', 'M', 'Silva', 12346789, 'rua silva de prata 29, Carangola - Cidade das flores'),
       ...
       ('Ricardo', 'F', 'Silva', 45678913, 'avenidade alemeda vinha 10099, Centro - Cidade das flores'),
 ...
 insert into orders (idOrderClient, orderStatus, orderDescription, sendValue, paymentCash) values
       ...
       select * from orders;     
      -- 21:50:47	insert into productOrder (idPOproduct, idPOorder, poQuantity, poStatus) values     (1,5,2,null),                 (2,5,1,null),                 (3,6,1,null)	Error Code: 1452. Cannot add or update a child row: a foreign key constraint fails (`ecommerce_refinado`.`productorder`, CONSTRAINT `fk_productorder_product` FOREIGN KEY (`idPOorder`) REFERENCES `orders` (`idOrder`))	0.000 sec
       ...
       -- Recuperar quantos pedidos foram realizados pelos clientees
